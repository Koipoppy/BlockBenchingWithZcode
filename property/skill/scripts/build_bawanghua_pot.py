...
Writes ../bawanghua_flower_pot.bbmodel (texture embedded as a data URI) and
../bawanghua_flower_pot.png (the same texture, standalone, for a resource pack).
...
OUT_DIR = os.path.join(os.path.dirname(HERE), "example")
